  ...
  useEffect(() => {
    ...
    return(
        ...
        <div className="container-1040">
          {loading ? <SkeletonLoading w={"300px"} h={"24px"} mb={"50px"}/> : <h1>Статьи для саморазвития</h1>
          }
          <div className="article-contents">
            <div className="content-left">
              {loading ? <SkeletonLoading w={"99%"} h={"99%"}/> : <div className="article-card">
            ...
            {loading ? <SkeletonLoading h={"100%"} /> : <div className="content-right">
              <div className="article-card">
                <p className="card-data">26 Июня 2024</p>
                <p className="card-title">Саморазвитие: Пошаговый План для Достижения Личных и Профессиональных
                  Целей</p>
